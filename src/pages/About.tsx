export function About() {
  return (
    <div id="about" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-cream min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="text-center">
            ...
            <h3 className="font-serif text-lg mb-2">Quality</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-lg mb-2">Sustainability</h3>
            <p className="text-sm text-muted-foreground">
